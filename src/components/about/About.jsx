    ...
    <section className="about section" id="about">
      ...
      <div className="about__container container grid">
        ...
        <div className="about__data">
          ...
          Sou nutricionista licenciada pela Faculdade de Ciências da Nutrição e Alimentação da Universidade do Porto. Com mais de uma década de experiência, atuo tanto online quanto em clínicas e hospitais privados no Brasil e em Portugal.<br></br>Minha paixão é o estudo do comportamento alimentar humano. Minha formação abrange nutrição clínica, ciências gastronômicas, avaliação metabólica e psicanálise.<br></br>Meu objetivo é promover saúde física e mental por meio de uma abordagem personalizada e embasada em evidências científicas.
